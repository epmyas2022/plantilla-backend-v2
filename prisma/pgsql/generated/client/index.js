...
const config = {
  ...
  "inlineSchemaHash": "5db270d292ed8f1e395fc26c58720b7f49c2c694aadb071444b986e9bb6fcd83",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/pgsql/generated/client",
    "pgsql/generated/client",
  ]
...
path.join(process.cwd(), "prisma/pgsql/generated/client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/pgsql/generated/client/schema.prisma")
